...
class Seq2SeqModel(object):
    ...
    def init_placeholders(self):       
        ...
        if self.mode == 'train':
            ...
            #    shape=[self.batch_size, 1], dtype=tf.int32) * self.end_token            
            ...
            plc = tf.ones(shape=[self.batch_size,1], dtype=tf.int32) * self.pad_token
            self.decoder_targets_train = tf.concat([self.decoder_inputs,plc], axis=1)
